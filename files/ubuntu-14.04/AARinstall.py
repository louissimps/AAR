...
if __name__ == '__main__':
    ...
    root_dbpswd = "shfdglkjasfhglisr837jg43g"
...
# Generate AAR_config.py with secrets    
    ...
    cur = db.cursor()
    check_db_exist_sql = "select count(*) from information_schema.SCHEMATA where SCHEMA_NAME='AARdb';"
    cur.execute(check_db_exist_sql)
    number = cur.fetchone()
    cur.close()
